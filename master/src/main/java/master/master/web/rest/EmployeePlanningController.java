...
/**
 * REST controller for managing employee planning and work schedules. Provides endpoints for
 * managers to create, update, view, and delete employee planning.
 */
@RestController
...
public class EmployeePlanningController {
  ...
  public ResponseEntity<EmployeePlanningDto> getEmployeePlanning(
      @PathVariable Long employeeId, Authentication authentication) {
    authorizationService.requireSelfOrAdmin(employeeId, authentication);
    try {
