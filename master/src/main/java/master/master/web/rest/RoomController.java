...
public class RoomController {
  ...
  public Room create(@RequestBody RoomDto dto) {
    ...
    room.setLastMaintenanceDate(
        dto.getLast_maintenance_date() != null ? dto.getLast_maintenance_date() : null);
    room.setNextMaintenanceDate(
        dto.getNext_maintenance_date() != null ? dto.getNext_maintenance_date() : null);
    room.setName(dto.getName() != null ? dto.getName() : "Room " + dto.getNumber());
    room.setPrice(dto.getPrice() != null ? dto.getPrice() : 100.0);
    room.setCreatedAt(
        dto.getCreated_at() != null ? dto.getCreated_at() : java.time.LocalDateTime.now());
    room.setCreatedBy(dto.getCreated_by() != null ? dto.getCreated_by() : "system");
    room.setUpdatedAt(
        dto.getUpdated_at() != null ? dto.getUpdated_at() : java.time.LocalDateTime.now());
  ...
  public ResponseEntity<String> handleConstraintViolation(DataIntegrityViolationException e) {
    ...
    return ResponseEntity.badRequest().body("Invalid room data: " + causeMessage);
  }
}
