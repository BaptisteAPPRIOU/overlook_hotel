...
public class EmployeePlanningService {
    ...
    private static final double DEFAULT_WEEKLY_HOURS = 35.0;
    private static final double DEFAULT_DAILY_HOURS = 7.0; // 35h / 5 days
    ...
    private LocalTime getStartTimeForDay(CreatePlanningRequestDto request, Integer dayOfWeek) {
        switch (dayOfWeek) {
            case 1:
                return request.getMondayStart() != null ? request.getMondayStart() : request.getStartTime();
            case 2:
                return request.getTuesdayStart() != null ? request.getTuesdayStart() : request.getStartTime();
            case 3:
                return request.getWednesdayStart() != null ? request.getWednesdayStart() : request.getStartTime();
            case 4:
                return request.getThursdayStart() != null ? request.getThursdayStart() : request.getStartTime();
            case 5:
                return request.getFridayStart() != null ? request.getFridayStart() : request.getStartTime();
            case 6:
                return request.getSaturdayStart() != null ? request.getSaturdayStart() : request.getStartTime();
            case 7:
                return request.getSundayStart() != null ? request.getSundayStart() : request.getStartTime();
            default:
    ...
    private LocalTime getEndTimeForDay(CreatePlanningRequestDto request, Integer dayOfWeek) {
        switch (dayOfWeek) {
            case 1:
                return request.getMondayEnd() != null ? request.getMondayEnd() : request.getEndTime();
            case 2:
                return request.getTuesdayEnd() != null ? request.getTuesdayEnd() : request.getEndTime();
            case 3:
                return request.getWednesdayEnd() != null ? request.getWednesdayEnd() : request.getEndTime();
            case 4:
                return request.getThursdayEnd() != null ? request.getThursdayEnd() : request.getEndTime();
            case 5:
                return request.getFridayEnd() != null ? request.getFridayEnd() : request.getEndTime();
            case 6:
                return request.getSaturdayEnd() != null ? request.getSaturdayEnd() : request.getEndTime();
            case 7:
                return request.getSundayEnd() != null ? request.getSundayEnd() : request.getEndTime();
            default:
