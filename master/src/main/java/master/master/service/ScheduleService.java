...
/**
 * Service for managing employee schedules and timesheet operations. Provides functionality for
 * weekly, monthly, and date range schedule views.
 */
@Service
@Transactional
public class ScheduleService {
  ...
  /**
   * Get weekly schedules for all employees. Returns schedule data formatted for the weekly view
   * table.
   */
  public List<WeeklyScheduleDto> getWeeklySchedules() {
    ...
    for (Employee employee : employees) {
      ...
      List<Integer> workdays =
          employeeWorkdayRepository.findWorkdaysByEmployeeId(employee.getUserId());
  ...
  /**
   * Get monthly schedules for all employees. Returns schedule data formatted for the monthly view
   * table.
   */
  ...
  /**
   * Get schedules for a specific date range. Returns schedule data formatted for the date range
   * view.
   */
  ...
  /**
   * Export timesheet data as Excel file. This is a placeholder implementation - you'll need to
