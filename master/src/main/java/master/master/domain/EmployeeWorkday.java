...
/**
 * Entity representing the association between an Employee and a specific workday. Utilizes a
 * composite primary key defined by {@link WorkdayId}.
 *
 * <p>Fields:
 *
 * <ul>
 *   <li>{@code id} - Composite key containing employee and workday identifiers.
 *   <li>{@code employee} - Reference to the associated {@link Employee} entity.
 * </ul>
 *
 * <p>The {@code @MapsId("employeeId")} annotation ensures that the employee part of the composite
 * key is mapped to the {@code employee_id} column in the database.
 */
@Getter
@Setter
@Entity
